...
describe('Users Controller', () => {
    ...
    describe('changePassword', () => {
        it('should change password successfully', async () => {
            ...
            // Assert
            expect(bcryptService.comparePassword).toHaveBeenCalledWith('oldpassword123', 'oldhashedpassword')
        ...
        it('should handle validation errors', async () => {
            ...
            // Act & Assert
            await expect(changePassword(mockContext)).rejects.toThrow('Password must be at least 8 characters')
        })
    ...
    describe('Users Service', () => {
        ...
        describe('updateUser', () => {
            ...
            it('should throw error if email already exists', async () => {
                ...
                // Act & Assert
                await expect(usersService.updateUser(1, mockUpdateData)).rejects.toThrow('Email already exists')
            })
            ...
            it('should throw error if username already exists', async () => {
                ...
                // Act & Assert
                await expect(usersService.updateUser(1, mockUpdateData)).rejects.toThrow('Username already exists')
            })
            ...
            it('should throw error if no valid fields to update', async () => {
                ...
                // Act & Assert
                await expect(usersService.updateUser(1, mockUpdateData)).rejects.toThrow('No valid fields to update')
            })
        })
        ...
        describe('changePassword', () => {
            ...
            it('should handle errors during password change', async () => {
                ...
                // Act & Assert
                await expect(usersService.changePassword(1, mockPasswordData)).rejects.toThrow('Database update failed')
            })
        })
    })
})
